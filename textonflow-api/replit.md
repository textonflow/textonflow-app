...
### Versiones de caché — CADA archivo tiene su propio número:
- `i18n.js?v=250` — actualizar al modificar i18n.js
- `app.js?v=284` — actualizar al modificar app.js
- Los 4 archivos CSS no tienen `?v=` (se sirven sin cache-bust; agregar si se necesita)
...
Los selectores que aparecen múltiples veces siguen estos patrones válidos:
- **Media query override:** misma clase, distintos breakpoints (`@media (max-width: 768px)`, `480px`, etc.)
