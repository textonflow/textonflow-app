...
# QR, sin tener que regenerar nada. La lógica vive en fecha_utils.py (compartida
# con el render para que {{fecha_actual}} también funcione dentro de las imágenes).
...
async def fecha_actual(tz: str = "America/Mexico_City"):
    ...
    """
    from fecha_utils import fecha_payload
    return JSONResponse(fecha_payload(tz))
