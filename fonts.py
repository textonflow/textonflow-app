...
FONT_MAPPING = {
    ...
    # ── Colección Premium ────────────────────────────────────────────────────
    "HunterRiver":            "./fonts/HunterRiver-Regular.otf",
    "Boorsok":                "./fonts/Boorsok-Regular.otf",
    "518Regular":             "./fonts/518-Regular.otf",
    "518Light":               "./fonts/518-Light.otf",
    "GardenFlower":           "./fonts/GardenFlower-Regular.otf",
    "TheDolbakBrush":         "./fonts/TheDolbak-Brush.ttf",
    "Post":                   "./fonts/Post-Regular.otf",
    "North":                  "./fonts/North-Regular.otf",
    "BeardyScript":           "./fonts/BeardyScript-Regular.otf",
    "Holidaze":               "./fonts/Holidaze-Regular.otf",
    "TeenageMarley":          "./fonts/TeenageMarley-Regular.ttf",
    "WestRiver":              "./fonts/WestRiver-Regular.otf",
    "BlackMystique":          "./fonts/BlackMystique-Regular.otf",
    "ArtisanMaker":           "./fonts/ArtisanMaker-Regular.otf",
    "RightPotions":           "./fonts/RightPotions-Regular.otf",
    "TRTBurnLight":           "./fonts/TRTBurn-Light.ttf",
    "TRTBurn":                "./fonts/TRTBurn-Regular.ttf",
    "TRTBurnMedium":          "./fonts/TRTBurn-Medium.ttf",
    "TRTBurnSemiBold":        "./fonts/TRTBurn-SemiBold.ttf",
    "TRTBurnBold":            "./fonts/TRTBurn-Bold.ttf",
    "TRTBurnExtraBold":       "./fonts/TRTBurn-ExtraBold.ttf",
    # ── MYKOZ Brand Fonts ────────────────────────────────────────────────────
